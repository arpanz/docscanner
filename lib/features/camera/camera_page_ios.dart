// lib/features/camera/camera_page_ios.dart
...
/// iOS camera page using flutter_doc_scanner package.
/// 
/// This is a thin wrapper around the existing flutter_doc_scanner
/// implementation for iOS platforms.
class CameraPageIos extends ConsumerStatefulWidget {
  const CameraPageIos({super.key, this.existingDocId});
  final int? existingDocId;

  @override
  ConsumerState<CameraPageIos> createState() => _CameraPageIosState();
}

class _CameraPageIosState extends ConsumerState<CameraPageIos> {
  @override
  void initState() {
    super.initState();
